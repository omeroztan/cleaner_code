...
class MyCallbacks:
    ...
    def early(self):
        my_early = EarlyStopping(monitor='val_loss', patience=self.patience, verbose=0, mode='min')
        return my_early
    ...
    def model_checkpoint(self):
        ...
        mc = ModelCheckpoint(filepath=f"{time.time()}_{checkpoint_path}", monitor='val_loss', mode='min', verbose=0)
        return mc
